...
console.log('%cCERTIER', 'color: #9b59b6; font-size: 40px; font-weight: bold; text-shadow: 2px 2px 4px rgba(155, 89, 182, 0.5);');
console.log('%cWelcome to the source! 🚀', 'color: #3498db; font-size: 16px;');
